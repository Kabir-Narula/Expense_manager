...
router.patch('/:year/:month/incomes/:incomeId', protect, accountContext, updateIncome);
router.delete('/:year/:month/incomes/:incomeId', protect, accountContext, deleteIncome);

// Month-scoped Expense
router.post('/:year/:month/expenses', protect, accountContext, createExpense);
router.patch('/:year/:month/expenses/:expenseId', protect, accountContext, updateExpense);
router.delete('/:year/:month/expenses/:expenseId', protect, accountContext, deleteExpense);
