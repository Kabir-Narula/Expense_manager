      ...
      >
        ...
        >
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <h2 className="text-2xl font-bold text-white">
                  {type === "addIncome" ? "Add Income" : "Edit Income"}
                </h2>
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-5">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 rounded-xl border-2 border-gray-200 focus:border-emerald-500 focus:ring-4 focus:ring-emerald-500/10 transition-all text-gray-900 font-medium placeholder-gray-400"
                  value={sourceUI}
            ...
            <div>
              <label className="block text-sm font-bold text-gray-700 mb-2 flex items-center gap-2">
                <MdCalendarToday className="w-4 h-4 text-emerald-600" />
                Date
              </label>
              <input
                type="date"
                className="w-full px-4 py-3 rounded-xl border-2 border-gray-200 focus:border-emerald-500 focus:ring-4 focus:ring-emerald-500/10 transition-all text-gray-900 font-medium"
                value={startDateUI}
            ...
            <div>
              ...
              <input
                type="text"
                placeholder="work, bonus, salary (comma-separated)"
                className="w-full px-4 py-3 rounded-xl border-2 border-gray-200 focus:border-emerald-500 focus:ring-4 focus:ring-emerald-500/10 transition-all text-gray-900 placeholder-gray-400"
                value={tagsUI}
            ...
            <div>
              <label className="block text-sm font-bold text-gray-700 mb-2 flex items-center gap-2">
                <MdRepeat className="w-4 h-4 text-emerald-600" />
                Recurrence
              </label>
              <select
                className="w-full px-4 py-3 rounded-xl border-2 border-gray-200 focus:border-emerald-500 focus:ring-4 focus:ring-emerald-500/10 transition-all text-gray-900 font-medium bg-white cursor-pointer"
                value={recurringUI}
              ...
              >
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <input
                      type="date"
                      className="w-full px-4 py-3 rounded-xl border-2 border-gray-200 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/10 transition-all text-gray-900 disabled:bg-gray-100 disabled:cursor-not-allowed"
                      value={endDateUI}
            ...
            <div className="flex gap-3 pt-2">
              ...
              <button
                type="submit"
                disabled={loading || !sourceUI || !amountUI || !startDateUI}
                className="flex-1 px-5 py-3 bg-gradient-to-r from-emerald-500 to-emerald-600 text-white rounded-xl font-semibold shadow-lg shadow-emerald-500/25 hover:shadow-xl hover:shadow-emerald-500/40 hover:-translate-y-0.5 transition-all disabled:opacity-50 disabled:cursor-not-allowed group"
              >
                {loading ? (
                  ...
                  <span className="flex items-center justify-center gap-2">
                    {type === "addIncome" ? "Add Income" : "Save Changes"}
                    <svg
